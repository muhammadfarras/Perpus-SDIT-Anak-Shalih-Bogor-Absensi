...
public class CaptureThread extends Thread
{
    ...
    private void Capture(){
        try{
            ...
            if(bReady){
                //capture
                System.out.println("\u001B[31m"+"Tiga Freeze (Capture Thread)"+"\u001B[0m");
                Reader.CaptureResult cr = m_reader.Capture(m_format, m_proc, 500, -1);
                System.out.println("\u001B[31m"+"Empat unfreeze (Capture Thread)"+"\u001B[0m");
            ...
            System.out.println("\u001B[31m"+"Has been canceled"+"\u001B[31m");
